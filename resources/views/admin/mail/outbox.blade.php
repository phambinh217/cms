@extends('Cms::layouts.default',[
	'active_admin_menu' 	=> ['mail', 'mail.outbox'],
	'breadcrumbs' 			=> [
		'title'	=> ['Tin nhắn', 'Hộp thư đi'],
		'url'	=> [
			admin_url('mail')
		],
	],
	            ...
	            <div class="form-body">
	                <div class="row">
	                    ...
	                    <div class="col-sm-6 md-pl-0">
	                    	<div class="form-group">
	                            <label class="control-label col-md-3">Gửi lúc</label>
	                            <div class="col-md-9">
	                                <input type="text" name="created_at" placeholder="Gửi lúc" value="{{ isset($filter['created_at']) ? $filter['created_at'] : '' }}" class="form-control" />
	                            </div>
	                        </div>
	                    </div>
	                </div>
		...
		<table class="master-table table table-striped table-hover table-checkable order-column pb-mails">
			<thead>
				<tr>
					...
					<th>
						{!! $mail->linkSort('Người nhận', 'first_name') !!}
					</th>
					<th>
