...
<!--<![endif]-->
    <head>
        ...
        <link href="{{ url('assets/admin/global/plugins/bootstrap/css/bootstrap.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ url('assets/admin/global/plugins/uniform/css/uniform.default.min.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ url('assets/admin/global/plugins/bootstrap-switch/css/bootstrap-switch.min.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ url('assets/admin/global/plugins/animate/animate.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ url('assets/admin/global/css/components-md.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ url('assets/admin/global/css/plugins-md.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ url('assets/admin/layouts/layout4/css/layout.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ url('assets/admin/layouts/layout4/css/custom.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ url('assets/admin/layouts/layout4/css/themes/green.css') }}" rel="stylesheet" type="text/css" />
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo page-md">
        ...
        <script src="{{ url('assets/admin/global/scripts/handle.js') }}" type="text/javascript"></script>
        <script src="{{ url('assets/admin/layouts/layout4/scripts/layout.min.js') }}" type="text/javascript"></script>
        <script src="{{ url('assets/admin/layouts/layout4/scripts/demo.min.js') }}" type="text/javascript"></script>
