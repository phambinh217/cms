 ...
 * @package: PhambinhCMS
 */
namespace Phambinh\Cms\Authenticate\Providers;
...
class ModuleServiceProvider extends ServiceProvider
{
    ...
    {
        \Module::registerFromJsonFile('authenticate', __DIR__ .'/../../module.json');
        $this->app->register(\Phambinh\Cms\Authenticate\Providers\RoutingServiceProvider::class);
    }
}
