...
namespace Phambinh\Cms\Mail\Models;
...
class Mail extends Model
{
    ...
    {
        return $this->beLongsTo('Phambinh\Cms\User\Models\User', 'sender_id');
    }

    public function receiver()
    {
        return $this->beLongsTo('Phambinh\Cms\User\Models\User', 'receiver_id');
    }
