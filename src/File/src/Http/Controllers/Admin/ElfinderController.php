...
namespace Phambinh\Cms\File\Http\Controllers\Admin;

use Illuminate\Http\Request;
use Phambinh\Cms\File\Supports\ElfinderConnector;
use AdminController;
        ...
        if (empty($roots)) {
            ...
            foreach ($dirs as $dir) {
                ...
                $roots[] = [
                    ...
                    'accessControl' => 'Phambinh\Cms\File\Http\Controllers\Admin\ElfinderController::checkAccess', // filter callback (OPTIONAL),
                    'autoload' => true,
