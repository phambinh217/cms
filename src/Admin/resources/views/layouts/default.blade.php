...
@section('blank.main')
    <div class="page-header navbar navbar-fixed-top">
        <div class="page-header-inner ">
            ...
            @include('Admin::section.page-action')
            <div class="page-top hidden-xs">
                @include('Admin::section.top-navgation-menu')
            </div>
        </div>
    </div>
    ...
    <div class="page-container">
        <div class="page-sidebar-wrapper">
            <div class="page-sidebar navbar-collapse collapse">
                @include('Admin::section.sidebar-menu', [
        ...
        <div class="page-content-wrapper">
            <div class="page-content">
                @if($__env->yieldContent('page_title'))
                    <div class="page-head">
                        ...
                        <div class="page-toolbar">
                            @include('Admin::section.theme-panel')
                ...
                @endif
                @include('Admin::section.breadcrumb', [
                    'breadcrumbs' => isset($breadcrumbs) ? $breadcrumbs : [],
                ])
                @yield('content')
            </div>
        </div>
        {{-- @include('Admin::section.qick-sidebar') --}}
    </div>
